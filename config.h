...
#define ALLOW_REACTIVE_EFFECTS
#elif RGB_MATRIX_KEYRELEASES
#undef RGB_MATRIX_KEYPRESSES
#define ALLOW_REACTIVE_EFFECTS
#endif
#ifdef ALLOW_REACTIVE_EFFECTS
...
#define RGB_MATRIX_STARTUP_VAL 30 //0-200 brightness

//custom effects enable
#undef EXAMPLE_CUSTOM_EFFECT1
